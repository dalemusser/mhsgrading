...
def main():
    ...
    if stale_tests:
        a(f"{n}. **{len(stale_tests)} stale test transcription(s)**: the `rubric-validation/` modules for "
    ...
    a("10. **Dev team vs dashboard:** dev team — player-field rename confirmation, "
      ...
      "grading-logic problems (Q7), dead-key cleanup, re-sync of stale `rubric-validation/` modules "
