...
Usage (from the repository root):
    ...
    python gameplay-logs-pp-audit/scripts/run_audit.py --log-dir playthrough-logs-and-results/09-01-26 --build-label 09-01-26
...
def main():
    ...
    ap.add_argument("--outputs-dir", help="run-specific outputs dir relative to gameplay-logs-pp-audit/, e.g. outputs/08-31-26")
    ap.add_argument("--reports-dir", help="run-specific reports dir relative to gameplay-logs-pp-audit/, e.g. reports/08-31-26")
    args = ap.parse_args()
